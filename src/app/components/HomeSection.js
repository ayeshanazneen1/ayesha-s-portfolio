...
export default function HomeSection() {
  return (
    <section
      id="home"
      className="h-screen bg-[#3F3B37] text-[#EEE9DB] relative overflow-hidden"
    >
      {/* Decorative arrow */}
      <div className="absolute top-36 left-2 z-10">
        <Image
          src="/homePage/arrows.svg"
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 items-center h-full space-x-3 px-26">
          ...
          <div className="flex space-x-4 mt-6">
            <a
              ...
              className="
                ...
                focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#CFC9B5]
              "
            >
              See Work
            </a>
        ...
        <div className="relative flex justify-center md:justify-end">
          <div className="relative ">
            <Image
              src="/homePage/ayesha.png"
              alt="Ayesha's portrait"
              width={350}
              height={350}
              className="rounded-full shadow-full bg-[#CFC9B5]"
            />
